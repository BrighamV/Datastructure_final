...
# Using the linked list class provided create a linked list that looks like the following 
#  * bonus *   Use the insert_tail at least once
# linkedlist[123, jane, paul, steven, mike, sally, candice, joe, bob, sarah]

# Question 2

# alter Your linked list to look like the following. 
