class BST:                                                  # class for the Binary Search tree
    ...
    def _contains(self, data, node):
        ...
        * Hint * The logic of traversing through the tree is very similar to that of inserting into a tree.
        """
...
# write some tests(at least 3) to see if all of your numbers are in your tree. 